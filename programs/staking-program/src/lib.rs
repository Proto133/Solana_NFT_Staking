...
declare_id!("7qwQBAxGr9c5STpZeQRDYWsYXLNRjDfrFdZ4q3vkD6Fj");
...
pub mod staking_program {
    ...
    pub fn redeem(ctx: Context<Redeem>) -> Result<()> {
        ...
        // if ctx.accounts.stake_state.stake_state == StakeState::Locked {
        //     msg!("Account is locked");
        //     return err!(StakeError::LockedAccount);
        // }
        if ctx.accounts.stake_state.stake_state != StakeState::Staked {
            msg!("Stake account is not staking anything");
            return err!(StakeError::InvalidStakeState);
...
pub struct UserStakeInfo {
    ...
    // pub is_committed_to_lockup: bool,
    // pub lock_up_info: LockUpInfo,
