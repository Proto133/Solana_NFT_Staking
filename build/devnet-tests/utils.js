...
exports.program_id = new web3_js_1.PublicKey("7qwQBAxGr9c5STpZeQRDYWsYXLNRjDfrFdZ4q3vkD6Fj");
const RPC_ENDPOINT_URL = "https://api.devnet.solana.com";
const commitment = 'confirmed';
const connection = new web3_js_1.Connection(RPC_ENDPOINT_URL, commitment);
// MY WALLET SETTING
const id_json_path = require('os').homedir() + "/UWebDev/04_Web_3.0/Sol/staking_attempts/anchor-nft-staking/test_staking.json";
