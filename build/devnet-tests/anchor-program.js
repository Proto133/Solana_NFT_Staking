...
const programId = new web3_js_1.PublicKey("7qwQBAxGr9c5STpZeQRDYWsYXLNRjDfrFdZ4q3vkD6Fj");
...
function testStakingProgram() {
    return __awaiter(this, void 0, void 0, function* () {
        const nft = yield metaplex.nfts().create({
            uri: "https://arweave.net/IIZsSX7Gaz1ufSWxjCFLzDMojWjRxBV0FK76r8PVtkio",
            name: "Test nft",
            sellerFeeBasisPoints: 0
        }).run();
        console.log("USER WALLET: ", utils_1.wallet.publicKey.toBase58());
        console.log("nft edition address: ", nft.masterEditionAddress.toBase58());
        ...
        let userStakeAta = yield (0, spl_token_1.getOrCreateAssociatedTokenAccount)(connection, utils_1.wallet, const_1.stakeMint, utils_1.wallet.publicKey);
        const redeemTxid = yield program.methods.redeem()
            .accounts({
                user: utils_1.wallet.publicKey,
                nftTokenAccount: nft.tokenAddress,
                stakeState: stakeStatePda[0],
                stakeMint: const_1.stakeMint,
